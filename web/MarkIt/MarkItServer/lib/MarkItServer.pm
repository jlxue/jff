...
MarkItServer - The great new MarkItServer web application!

=head1 SYNOPSIS

    use MarkItServer;
    my $app = MarkItServer->new();
    $app->run();

=head1 ABSTRACT

A brief summary of what MarkItServer does.
...
This document describes MarkItServer Version 0.01
...
web application module MarkItServer...
...
C<bug-markitserver at rt.cpan.org>, or through the web interface at
L<http://rt.cpan.org/NoAuth/ReportBug.html?Queue=MarkItServer>.
