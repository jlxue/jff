...
sync_file $SCRIPT_DIR/srv/www/gitolite-shell-wrapper.sh /srv/www/gitolite-shell-wrapper.sh


ensure_mode_user_group /srv/git     700 git git
ensure_mode_user_group /srv/www/gitolite-shell-wrapper.sh   700 git git
