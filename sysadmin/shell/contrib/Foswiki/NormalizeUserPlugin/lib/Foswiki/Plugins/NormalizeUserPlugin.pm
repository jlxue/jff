...
---+ package Foswiki::Plugins::NormalizeUserPlugin
...
our $SHORTDESCRIPTION = 'Remove @REALM part in REMOTE_USER and capitalize first character for HTTP negotiate authentication';
...
sub initPlugin {
    ...
    # like this:
    # $Foswiki::cfg{Plugins}{NormalizeUserPlugin}{ExampleSetting} = 1;
    ...
    # LocalSite.cfg.
    # my $setting = $Foswiki::cfg{Plugins}{NormalizeUserPlugin}{ExampleSetting} || 0;
...
sub initializeUserHandler {
    ...
    #Foswiki::Func::writeDebug("loginName=$loginName" .
    #    " canonicalUserID=" .  Foswiki::Func::getCanonicalUserID($loginName) .
    #    " wikiName=" . Foswiki::Func::getWikiName($loginName) .
    #    " wikiUserName=" . Foswiki::Func::getWikiUserName($loginName) .
    #    " userToWikiName=" . Foswiki::Func::userToWikiName($loginName, 0)
    #);

    $loginName =~ s/\@.*$//;
    return ucfirst($loginName);
}
