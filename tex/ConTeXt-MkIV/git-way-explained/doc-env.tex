...
% new way:
\usemodule[zhfonts][style=dim]      % 'style=dim' means 'style= do it myself'

% you can set 'sans' and 'mono' respectively 
% and their 'regular', 'bold', 'italic', 'bolditalic'
\setupzhfonts[serif][regular=AdobeSongStd-Light,bold=AdobeHeitiStd-Regular,
                     italic=AdobeKaitiStd-Regular,bolditalic=AdobeHeitiStd-Regular,
                     slanted=AdobeKaitiStd-Regular,boldslanted=AdobeHeitiStd-Regular]

\setupzhfonts[sans][regular=AdobeKaitiStd-Regular,bold=AdobeHeitiStd-Regular,
                     italic=AdobeKaitiStd-Regular,bolditalic=AdobeHeitiStd-Regular,
                     slanted=AdobeKaitiStd-Regular,boldslanted=AdobeHeitiStd-Regular]

\setupzhfonts[mono][regular=AdobeFangsongStd-Regular,bold=AdobeHeitiStd-Regular,
                     italic=AdobeFangsongStd-Regular,bolditalic=AdobeHeitiStd-Regular,
                     slanted=AdobeFangsongStd-Regular,boldslanted=AdobeHeitiStd-Regular]

%\setuplatinfonts[serif][regular=texgyrepagella]
...
\setuptyping[before={\blank[.5em]\setupinterlinespace[medium]\startframedtext[width=fit]},
...
\useURL[TortoiseSVN][http://tortoisesvn.net/]
