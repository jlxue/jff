...
% Tested with TeXLive 20090919 on Debian Squeeze: (use `tlmgr show xxx` for details)
%  xetex        r14602  3.1415926-2.2-0.9995.2
%  pdftex       r15207  3.1415926-1.40.10-2.2
%  ctex         r15273  0.94
...
%         release v0.2
%
%   2009-09-19  Liu Yubao
%       * pdftex now supports ttc embedding.
%       * ctex has been improved to support bookmarks better, but I decide to keep them in this
%         template because ctex doesn't contain ccmap and zhwinfonts yet.
%
